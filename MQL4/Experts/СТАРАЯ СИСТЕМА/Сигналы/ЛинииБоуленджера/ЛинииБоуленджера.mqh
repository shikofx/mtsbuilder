...
bool ЛинииБоуленджера::ПоказатьНаправлениеЛинии()
  {
   double уровеньТекущий=iBands(Symbol(),таймфрейм,период,отклонение,сдвиг,PRICE_LOW,MODE_LOWER,номер_точки);
   double уровеньПредыдущий=iBands(Symbol(),таймфрейм,период,отклонение,сдвиг,PRICE_LOW,MODE_LOWER,номер_точки+1);
