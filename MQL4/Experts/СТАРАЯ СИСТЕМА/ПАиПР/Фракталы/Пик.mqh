...
public:
   double            цена;
   datetime          врем€;
   void              ”становить»м€(string _им€) {им€=IntegerToString(направление)+"___"+_им€+"___"+TimeToString(врем€);}
   string            ѕолучить»м€(){return(им€);}

   void              ”становить÷ену(double _цена) {цена=_цена;}
   void              ”становить÷ену();
   double            ѕолучить÷ену(){return(цена);}

   void              ”становить¬рем€(datetime _врем€){врем€=_врем€;}
   void              ”становить¬рем€(){врем€=Time[свечи_справа+сдвиг+1];}
   datetime          ѕолучить¬рем€(){return(врем€);}

   void              ”становить—вечи—права(int _свечи_справа){свечи_справа=_свечи_справа;}
   int               ѕолучить—вечи—права(){return(свечи_справа);}
   void              ”становить—вечи—лева(int _свечи_слева){свечи_слева=_свечи_слева;}
   int               ѕолучить—вечи—лева(){return(свечи_слева);}
   void              ”становитьЌаправление(bool _направление){направление=_направление;}
   bool              ѕолучитьЌаправление(){return(направление);}
   void              ”становить÷вет—трелки(color _цвет){цвет=_цвет;}
   color             ѕолучить÷вет—трелки(){return(цвет);}
   void              ”становить—двиг(int _сдвиг){сдвиг=_сдвиг;}
   int               ѕолучить—двиг(){return(сдвиг);}
...
void ѕик::ѕоставить—трелку()
  {
   if(!направление)
     {
      ObjectCreate(0,им€,OBJ_ARROW_DOWN,0,врем€,цена-(вертикальное—мещение*50+30)*Point);
   ...
   if(направление)
     {
      ObjectCreate(0,им€,OBJ_ARROW_UP,0,врем€,цена+(вертикальное—мещение*50+60)*Point);
